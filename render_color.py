...
points = read_ply("/home/rick/Datasets/Custom_tum/points3D.ply")
tmp = np.array(points)
pcd = o3d.geometry.PointCloud()
pcd.points = o3d.utility.Vector3dVector(tmp[:,:3])
pcd.colors = o3d.utility.Vector3dVector(np.ones((tmp.shape[0], 3)) * 0.5)
pcd.normals = o3d.utility.Vector3dVector(np.zeros((tmp.shape[0], 3)))
# 保存为PLY文件
o3d.io.write_point_cloud("/home/rick/Datasets/Custom_tum/points3D1.ply", pcd)